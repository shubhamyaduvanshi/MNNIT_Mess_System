...
AppControllers.controller('AdminCtrl',
        function AdminCtrl($scope, $location, StudentResources,StudentService) {
            ...
            $scope.menu = [{name: 'Current Month Extra Food', link: 'currentmonth'},
                {name: 'Previous Months Bill', link: 'prevmonths'}, {name: 'Feedback', link: 'forum'},
                {name: 'Rate My Mess', link: 'ratemess'}, {name: 'Log Out', link: 'logout'},{name: 'Change Password', link: 'changepassword'}];
...
AppControllers.controller('ChangePasswordCtrl',
        function ChangePasswordCtrl($scope, StudentResources, StudentService) {
