...
AppControllers.controller('AdminCtrl',
        function AdminCtrl($scope, $location, $rootScope, AdminResources,AdminService) {
            ...
            $scope.menu = [{name: 'Add Student', link: 'messentry'},
                {name: 'Add Extra Food', link: 'extrasentry'}, {name: 'Mess Leave', link: 'messcuts'},
                {name: 'Payment Details', link: 'billings'}, {name: 'Analysis', link: 'analysis'},
              {name: 'Feedback', link: 'forum'}, {name: 'About Mess', link: 'messinfo'}, {name: 'Log Out', link: 'logout'},{name: 'Change Password', link: 'changepassword'}];
            $scope.current = "";
...
AppControllers.controller('ChangePasswordCtrl',
        function ChangePasswordCtrl($scope, AdminResources) {
